...
const NewsUpdates = () => {
  const newsItems = [
    {
      id: 1,
      title: 'New Token Bridge Partnership with Initia Network',
      excerpt: 'APT Casino partners with Initia Network to provide seamless cross-chain token transfers with lower fees.',
      date: '2025-05-08',
    ...
    {
      id: 2,
      title: 'INIT Governance Proposal: Community Jackpots',
