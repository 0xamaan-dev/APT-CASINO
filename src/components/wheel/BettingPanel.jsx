    ...
    <div className="bg-[#290023] border border-[#333947] rounded-3xl p-4 flex flex-col h-full">
      ...
      <div className="mb-4">
        <div className="flex justify-between p-1 mb-1">
          ...
          <div className="text-sm">{formatDisplayBalance(betAmount)}</div>
        </div>
      ...
      <button
        ...
        className={`py-3 mt-4 rounded-lg text-center font-semibold transition-all w-full border-2 ${isSpinning || betAmount <= 0 || betAmount > balance || balance <= 0
