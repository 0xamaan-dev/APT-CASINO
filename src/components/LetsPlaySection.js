...
export default function LetsPlaySection() {
  ...
  const [stats, setStats] = useState([
    ...
    { icon: <FaCoins className="text-yellow-400" />, value: 0, target: 1000000, label: "INIT wagered" }
  ]);
  ...
  return (
    <section id="letsplay" className="relative py-24 md:py-32 px-4 sm:px-8 md:px-16 lg:px-24 xl:px-36 overflow-hidden">
