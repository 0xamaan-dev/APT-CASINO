      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-6">
        ...
        <div className="flex flex-wrap gap-8 justify-center md:justify-end">
          <div className="flex flex-col items-center">
            ...
            <p className="text-xs uppercase mt-1 text-white/70">Total INIT Pool</p>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-xs uppercase mt-1 text-white/70">INIT APY</p>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-xs uppercase mt-1 text-white/70">INIT Price</p>
          </div>
