              ...
              <div className="flex items-center gap-3">
                ...
                {isConnected && (
                  <button
                    ...
                    className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${totalVRF > 0
        ...
        <footer className="bg-white border-t mt-16">
          <div className="max-w-7xl mx-auto px-4 py-8">
            <div className="text-center text-gray-600">
              ...
              <p className="text-sm">
                All games use Pyth Entropy for verifiable randomness on Initia Network
              </p>
            </div>
          </div>
        </footer>
