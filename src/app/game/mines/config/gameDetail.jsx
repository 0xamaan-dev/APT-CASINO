...
export const gameStatistics = {
  totalBets: '956,421',
      totalVolume: '4.7M INIT',
    avgBetSize: '1.85 INIT',
    maxWin: '1,217.50 INIT'
};

export const recentBigWins = [
      { player: "CryptoMiner", amount: "1,217.50 INIT", time: "3m ago", config: "10 mines" },
    { player: "DiamondHands", amount: "892.50 INIT", time: "10m ago", config: "5 mines" },
    { player: "GemHunter", amount: "653.00 INIT", time: "22m ago", config: "3 mines" },
    { player: "RiskTaker", amount: "437.00 INIT", time: "45m ago", config: "3 mines" },
    { player: "TreasureSeeker", amount: "381.50 INIT", time: "1h ago", config: "1 mine" }
];
